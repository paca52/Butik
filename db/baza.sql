...
CREATE TABLE table_artikli (
	id_artikla BIGINT NOT NULL PRIMARY KEY,
...
CREATE TABLE table_racun_header (
	id_racuna BIGINT NOT NULL PRIMARY KEY,
...
CREATE TABLE table_dostava (
	id_dostava BIGINT NOT NULL PRIMARY KEY,
	datum_dostave DATE NOT NULL,
	dostavljac VARCHAR(255) NOT NULL,
	id_artikla BIGINT NOT NULL,
	kolicina_artikla INTEGER NOT NULL
);

ALTER TABLE table_dostava 
ADD CONSTRAINT FK_table_dostava_table_artikli
FOREIGN KEY (id_artikla) REFERENCES table_artikli(id_artikla);
...
VALUES
('1234567890123', 'John', 'Doe', 40, 10, NULL, '2024-01-01', 'Sales', 20, 'JohnDoeSales', 'Sales', 1),
('1234567890124', 'Jane', 'Smith', 35, 12, NULL, '2024-01-02', 'Marketing', 22, 'JaneSmithMarketing', 'Marketing', 1),
('1234567890125', 'Alice', 'Johnson', 38, 11, NULL, '2024-01-03', 'IT', 18, 'AliceJohnsonIT', 'IT', 1),
('1234567890126', 'Bob', 'Brown', 42, 9, NULL, '2024-01-04', 'Sales', 19, 'BobBrownSales', 'Sales', 1),
('1234567890127', 'Charlie', 'Davis', 37, 11, NULL, '2024-01-05', 'Marketing', 21, 'CharlieDavisMarketing', 'Marketing', 1),
('1234567890128', 'David', 'Wilson', 39, 10, NULL, '2024-01-06', 'IT', 17, 'DavidWilsonIT', 'IT', 1),
('1234567890129', 'Eve', 'Miller', 36, 12, NULL, '2024-01-07', 'Sales', 20, 'EveMillerSales', 'Sales', 1),
('1234567890130', 'Frank', 'Moore', 41, 9, NULL, '2024-01-08', 'Marketing', 22, 'FrankMooreMarketing', 'Marketing', 1),
('1234567890131', 'Grace', 'Lee', 38, 11, NULL, '2024-01-09', 'IT', 18, 'GraceLeeIT', 'IT', 1),
('1234567890132', 'Henry', 'Clark', 43, 10, NULL, '2024-01-10', 'Sales', 19, 'HenryClarkSales', 'Sales', 1),
('1234567890133', 'Ivy', 'Young', 37, 11, NULL, '2024-01-11', 'Marketing', 21, 'IvyYoungMarketing', 'Marketing', 1),
('1234567890134', 'Jack', 'Hill', 40, 9, NULL, '2024-01-12', 'IT', 17, 'JackHillIT', 'IT', 1),
('1234567890135', 'Kevin', 'Green', 36, 12, NULL, '2024-01-13', 'Sales', 20, 'KevinGreenSales', 'Sales', 1),
('1234567890136', 'Linda', 'Adams', 42, 10, NULL, '2024-01-14', 'Marketing', 22, 'LindaAdamsMarketing', 'Marketing', 1),
('1234567890137', 'Mike', 'Baker', 39, 11, NULL, '2024-01-15', 'IT', 18, 'MikeBakerIT', 'IT', 1),
('1234567890138', 'Nancy', 'Carter', 37, 10, NULL, '2024-01-16', 'Sales', 19, 'NancyCarterSales', 'Sales', 1),
('1234567890139', 'Olivia', 'Evans', 40, 12, NULL, '2024-01-17', 'Marketing', 21, 'OliviaEvansMarketing', 'Marketing', 1),
('1234567890140', 'Peter', 'Ford', 38, 9, NULL, '2024-01-18', 'IT', 17, 'PeterFordIT', 'IT', 1),
('1234567890141', 'Quincy', 'Graham', 44, 11, NULL, '2024-01-19', 'Sales', 20, 'QuincyGrahamSales', 'Sales', 1),
('0000000000000', 'admin', 'admin', 0, 0, NULL, '2024-01-01', 'admin', 0, 'admin', 'admin', 1),
('1234567890142', 'Rachel', 'Harris', 37, 10, NULL, '2024-01-20', 'Marketing', 22, 'RachelHarrisMarketing', 'Marketing', 1);
